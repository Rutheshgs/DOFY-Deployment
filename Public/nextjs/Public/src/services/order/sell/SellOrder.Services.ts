...
class SellOrderServices {
    ...
    GetOrderSummary(id: any, LanguageCode: any, CountryCode: any) {
        isTokenExpired();
        return http.get(`${this.serviceName}/getOrderSummary/${id}`, {
            headers: {
    ...
    ReEvaluteOrder(id: any, LanguageCode: any, CountryCode: any) {
        isTokenExpired();
        return http.get(`${this.serviceName}/ReEvaluteOrder/${id}`, {
            headers: {
                "LanguageCode": LanguageCode,
                "CountryCode": CountryCode
            }
    ...
    GetPersonOrders(data: IGetOrderListModel,LanguageCode: any, CountryCode: any) {
        isTokenExpired();
        return http.post(`${this.serviceName}/GetPersonOrders`, data,{
            headers: {
                "LanguageCode": LanguageCode,
                "CountryCode": CountryCode
            }
    ...
    UpdateReferalCode(referralCode: any, orderId: any) {
        isTokenExpired();
