...
class ReferralCodeServices {
    ...
    GetReferralCode(ReferralCode: any, PersonId: number, orderId: number) {
        isTokenExpired();
    ...
    RemoveReferralCode(ReferralCode: any, PersonId: number, orderId: number) {
        isTokenExpired();
    ...
    RemoveReferralCodeFromOrder(ReferralCode: any, PersonId: number, orderId: number) {
        isTokenExpired();
