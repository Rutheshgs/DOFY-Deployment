            ...
            if (res.status === 200) {
                ...
                setTimeout(() => {
                    if (HelperConstant.serviceTypeId.SELL === orderSummary.ServiceTypeId) {
                        ...
                        history.push(`/${getUserLanguage()}${getUserLocationForParam()}/schedule/${orderSummary.Appointment.OrderId}`);
                    }
                    else {
                        dispatch(addressPageChange("repairtimedateslot"));
                        history.push(`/${getUserLanguage()}${getUserLocationForParam()}/Repair-schedule/${orderSummary.Appointment.OrderId}`);
                    }
                }, 500);
            }
        })
