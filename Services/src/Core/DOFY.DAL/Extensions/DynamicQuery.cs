...
public static class DynamicQuery
{
    ...
    public static string GetInsertBulkQuery(string tableName, dynamic item)
    {
        PropertyInfo[] props = item.GetType().GetProperties();
    ...
    public static dynamic RemoveDefaultDateTimeValuesList(dynamic items)
    {
    ...
    /// <param name="searchColumns">search expression parameter</param>
    /// <param name="valueToSearch">search value expression parameter</param>
    /// <param name="pageIndex">represents page index</param>
    /// <param name="pageSize">represents page size</param>
    /// <param name="paging">page expression parameter</param>
    /// <param name="countQuery">count expression parameter</param>
    /// <returns>List of query objects</returns>
    ...
    private static string OrderByQuery<T>(SortExpression<T>[] sortExpressions)
    {
        ...
        {
            orderedQuery = string.Join(" ", sortExpressions.Select(item => string.Concat(item.SortBy.GetMemberName(), item.SortDirection.Equals(DataTables.AspNet.Core.SortDirection.Ascending) ? " ASC " : " DESC ")));
